// Test de la nouvelle route /agencies/logout
...
console.log("Test de la nouvelle route /agencies/logout\n");

// Fonction simulée de agencyLogout avec la nouvelle route
async function agencyLogout(token) {
  try {
    console.log("=== Requête simulée ===");
    console.log("URL:", `${API_BASE_URL}/agencies/logout`);
